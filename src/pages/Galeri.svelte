<div>
  <div class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-4xl font-bold text-center mb-2">GALERI SMPIT ARAFAH</h1>
      <div class="mb-8 text-gray-700 font-medium text-md text-center">
        galeri merupakan tempat untuk menampilkan berbagai macam foto yang telah
        diambil di SMPIT ARAFAH
      </div>
        ...
        >
          ...
          >
            <div class="absolute bottom-0 left-0 right-0 p-4">
              <h3 class="text-2xl font-bold text-white">Marawis</h3>
              <p class="text-white">
                Gemakan Harmoni Islami, Tebarkan Semangat Melalui Marawis SMPIT
                Arafah
              </p>
            </div>
          </div>
